...
A synthetic 3-page US Letter PDF that exercises multi-page handling. Page 1
has a centred company letterhead with "ACME Corporation" and address, body
text spans all three pages, the last page includes a hand-drawn-looking
signature and printed name, and every page has a centred page-number footer.
Regenerated by `scripts/generate-multi-page-report.js`.
